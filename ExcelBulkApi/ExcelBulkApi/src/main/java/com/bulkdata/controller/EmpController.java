...
@GetMapping("/getall")
    ...
    public ResponseEntity<?> updateEmployee(@RequestBody Employee employee,@PathVariable("employeid") int employeid){
            ...
            return new ResponseEntity<>("you have updated successfully"+employee.getEmployeid()+"at this",HttpStatus.OK);
    }
    ...
    return ResponseEntity.status(HttpStatus.ACCEPTED).body("it is uploaded"+id);
    }
